          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Coordinator Dashboard</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                ...
                <p className="text-xs text-slate-500">ผู้ประสานงาน</p>
              </div>
              <Button
                onClick={onLogout}
                variant="outline"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="glass-effect p-1 h-auto">
            ...
            <TabsTrigger value="projects" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-600 data-[state=active]:text-white">
          ...
          <TabsContent value="overview">
            <DashboardOverview userRole="coordinator" userId={user.username} />
          </TabsContent>

          <TabsContent value="projects">
            <ProjectList userRole="coordinator" userId={user.username} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
